...
if __name__ == "__main__":
    print("Word Count Application....")

    spark = SparkSession.builder.appName("Word Count Application").master("local[*]").getOrCreate()
    ...
    # writing the query 
    write_query = stream_word_count_df.writeStream.outputMode("complete").format("console").start()
    """
